        ...
        <div class="row typecho-page-main manage-metas">
                <div class="col-mb-12">
                    <ul class="typecho-option-tabs clearfix">
                        <li class="current"><a href="<?php $options->adminUrl('extending.php?panel=Puock/manage-links.php'); ?>"><?php _e('友情链接'); ?></a></li>
                        <li><a href="<?php $options->adminUrl('options-plugin.php?config=Puock'); ?>"><?php _e('设置'); ?></a></li>
                    </ul>
                </div>
                        ...
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('你确认要删除这些友链吗?'); ?>" href="<?php $security->index('/action/puock-links?do=delete'); ?>"><?php _e('删除'); ?></a></li>
                                    <li><a lang="<?php _e('你确认要启用这些友链吗?'); ?>" href="<?php $security->index('/action/puock-links?do=enable'); ?>"><?php _e('启用'); ?></a></li>
                                    <li><a lang="<?php _e('你确认要禁用这些友链吗?'); ?>" href="<?php $security->index('/action/puock-links?do=prohibit'); ?>"><?php _e('禁用'); ?></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-mb-12 col-tb-4" role="form">
                    <?php Puock_Plugin::linksForm()->render(); ?>
                </div>
        </div>
    </div>
</div>
...
$('input[name="email"]').blur(function() {
    ...
    if (_email != '' && _image == '') {
        var k = "<?php $security->index('/action/puock-links'); ?>";
    ...
    $(document).ready(function () {
        var table = $('.typecho-list-table').tableDnD({
            onDrop : function () {
                ...
                $.post('<?php $security->index('/action/puock-links?do=sort'); ?>',
                    $.param({lid : ids}));
